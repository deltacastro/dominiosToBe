...
let addRow = (form, modelData, route) => {
  ...
  opciones.innerHTML = `
        <a data-form="proveedorForm" data-nombre="${modelData.nombre}" data-put="${route.edit}" title="Editar" class="editar btn-floating btn-small waves-effect waves-light yellow"><i class="material-icons">edit</i></a>
        <a data-form="proveedorForm" data-nombre="${modelData.nombre}" data-delete="${route.edit}" title="Eliminar" class="eliminar btn-floating btn-small waves-effect waves-light red accent-4"><i class="material-icons">delete</i></a>
    `;
  removeValidClass();
}
