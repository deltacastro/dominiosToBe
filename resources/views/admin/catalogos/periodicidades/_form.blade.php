<div class="row">
    <form id="generalForm" class="col s12" method="POST" action="{{ route('admin.catalogo.periodicidad.store') }}" data-post="{{ route('admin.catalogo.periodicidad.store') }}"  data-put="">
        {{ csrf_field() }}
